...
## v2.3.1 (14/09/2017)
- [**closed**] Changelog for v2.3 does not mention breaking changes [#171](https://github.com/broofa/node-mime/issues/171)
...
- [**closed**] Add mime type for WOFF file format 2.3 [#102](https://github.com/broofa/node-mime/issues/102)
...
- [**closed**] Bump version to 1.2.3 [#18](https://github.com/broofa/node-mime/issues/18)
...
- [**closed**] npm install fails for 1.2.3 [#12](https://github.com/broofa/node-mime/issues/12)
