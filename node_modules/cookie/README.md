...
Specifies the `Date` object to be the value for the [`Expires` `Set-Cookie` attribute][rfc-6265-5.2.3].
...
Specifies the `number` (in seconds) to be the value for the [`Max-Age` `Set-Cookie` attribute][rfc-6265-5.2.3].
...
> node benchmark/parse.js
  ...
  duplicates  x   438,424 ops/sec ±2.37% (184 runs sampled)
